public class SamochodyDostawcze extends Pojazd {
    int ileDrzwi;
    public SamochodyDostawcze(String marka, String model, String nrRej, String kolor, double cena, double spalanie, double stanZbiornika, double licznik, int ileDrzwi)
    {
